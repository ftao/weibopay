...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(HERE, 'weibopay.db'), # Or path to database file if using sqlite3.
...
SECRET_KEY = '*t&0ry2k2uz=jnunlh%mar#wwz2i%(av&*xh3@b=6phoalg=1+'
